...
lv_obj_t *ui_PowerOutletDevicePanel;
lv_obj_t *ui_Image24;
lv_obj_t *ui_Button2;
lv_obj_t *ui_Label34;
void ui_event_ToggleButton( lv_event_t * e);
lv_obj_t *ui_ToggleButton;
lv_obj_t *ui_Label33;
lv_obj_t *ui_Button3;
lv_obj_t *ui_Label35;
lv_obj_t *ui_ThermometerDevicePanel;
lv_obj_t *ui_Image25;
lv_obj_t *ui_Co2SensorDevicePanel;
lv_obj_t *ui_Image26;
...
lv_anim_set_values(&PropertyAnimation_0, 0, 580 );
...
lv_anim_set_user_data(&PropertyAnimation_0, PropertyAnimation_0_user_data);
lv_anim_set_custom_exec_cb(&PropertyAnimation_0, _ui_anim_callback_set_x );
lv_anim_set_values(&PropertyAnimation_0, 0, -595 );
lv_anim_set_path_cb( &PropertyAnimation_0, lv_anim_path_overshoot);
...
void ui_event_Panel4( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_LONG_PRESSED) {
      _ui_screen_change( &ui_FanSettingsScreen, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_FanSettingsScreen_screen_init);
}
}
void ui_event_Panel3( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
...
void ui_event_Panel11( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_LONG_PRESSED) {
      _ui_screen_change( &ui_DayCounterScreen, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_DayCounterScreen_screen_init);
}
}
void ui_event_WifiIcon( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
...
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_LEDBrightnessScreen, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 300, 0, &ui_LEDBrightnessScreen_screen_init);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
lv_indev_wait_release(lv_indev_get_act());
...
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_LightDurationScreen, LV_SCR_LOAD_ANIM_MOVE_LEFT, 300, 0, &ui_LightDurationScreen_screen_init);
}
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_RIGHT  ) {
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_DayCounterScreen, LV_SCR_LOAD_ANIM_MOVE_RIGHT, 300, 0, &ui_DayCounterScreen_screen_init);
}
if ( event_code == LV_EVENT_SCREEN_UNLOAD_START) {
...
if ( event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT  ) {
lv_indev_wait_release(lv_indev_get_act());
      _ui_screen_change( &ui_LEDBrightnessScreen, LV_SCR_LOAD_ANIM_MOVE_LEFT, 300, 0, &ui_LEDBrightnessScreen_screen_init);
}
}
void ui_event_DayDownButton( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
...
void ui_event_ImgButton2( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
if ( event_code == LV_EVENT_CLICKED) {
      _ui_screen_change( &ui_SoftwareUpdateScreen, LV_SCR_LOAD_ANIM_FADE_ON, 500, 0, &ui_SoftwareUpdateScreen_screen_init);
}
}
void ui_event_ImgButton4( lv_event_t * e) {
    lv_event_code_t event_code = lv_event_get_code(e);lv_obj_t * target = lv_event_get_target(e);
