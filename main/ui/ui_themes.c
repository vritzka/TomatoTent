...
const ui_theme_variable_t _ui_theme_color_gray1[1] = {0x676767};
const ui_theme_variable_t _ui_theme_alpha_gray1[1] = {255};

const ui_theme_variable_t _ui_theme_color_Green1[1] = {0x079001};
const ui_theme_variable_t _ui_theme_alpha_Green1[1] = {255};
