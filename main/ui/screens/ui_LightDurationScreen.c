...
lv_obj_set_style_img_recolor(ui_ArrowDown, lv_color_hex(0x6B6B6B), LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_style_img_recolor(ui_ArrowUp, lv_color_hex(0x6B6B6B), LV_PART_MAIN| LV_STATE_DEFAULT);
