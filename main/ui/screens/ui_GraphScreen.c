...
lv_chart_series_t* ui_Chart2_series_1 = lv_chart_add_series(ui_Chart2, lv_color_hex(0x3B1BF4), LV_CHART_AXIS_PRIMARY_Y);
...
lv_chart_series_t* ui_Chart2_series_3 = lv_chart_add_series(ui_Chart2, lv_color_hex(0x808080), LV_CHART_AXIS_SECONDARY_Y);
