...
lv_obj_set_x( ui_DayCounterMainLabel, 12 );
...
lv_obj_set_x( ui_DayNightLabel, -32 );
lv_obj_set_y( ui_DayNightLabel, -15 );
lv_obj_set_align( ui_DayNightLabel, LV_ALIGN_TOP_MID );
lv_label_set_text(ui_DayNightLabel,"day");
lv_obj_set_style_text_font(ui_DayNightLabel, &lv_font_montserrat_20, LV_PART_MAIN| LV_STATE_DEFAULT);
...
lv_obj_set_y( ui_DimmerIconPanel, -144 );
