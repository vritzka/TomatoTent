...
lv_obj_set_x( ui_WifiPassword, -19 );
...
lv_obj_set_x( ui_WifiDropdown, -19 );
lv_obj_set_y( ui_WifiDropdown, -121 );
...
lv_obj_set_x( ui_WifiSwitch, -185 );
lv_obj_set_y( ui_WifiSwitch, -52 );
...
lv_obj_set_y( ui_ImgButton7, -125 );
...
lv_obj_set_x( ui_ImgButton2, 203 );
lv_obj_set_y( ui_ImgButton2, -62 );
...
lv_obj_set_x( ui_ImgButton4, 136 );
lv_obj_set_y( ui_ImgButton4, -121 );
