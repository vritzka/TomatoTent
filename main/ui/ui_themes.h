...
#define UI_THEME_COLOR_GRAY1 0
#define UI_THEME_COLOR_GREEN1 1
...
extern const ui_theme_variable_t _ui_theme_color_Green1[1];
extern const ui_theme_variable_t _ui_theme_alpha_Green1[1];
