...
void vSensorTask( void * pvParameters )
{
    ...
    gptimer_alarm_config_t alarm_config1 = {
        .reload_count = 0,
        .alarm_count = 30000000, // period = 30s
	...
	uint16_t attributes[] = {ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_VALUE_ID, ESP_ZB_ZCL_ATTR_TEMP_MEASUREMENT_MIN_VALUE_ID};
	...
	for( ;; )
	{
		if( xSemaphoreTake( xSemaphore, pdMS_TO_TICKS(10000) ) == pdTRUE ) {
            ...
            cmd_req.address_mode = ESP_ZB_APS_ADDR_MODE_16_ENDP_PRESENT;
            cmd_req.clusterID = ESP_ZB_ZCL_CLUSTER_ID_TEMP_MEASUREMENT;
            cmd_req.cluster_role = ESP_ZB_ZCL_CLUSTER_CLIENT_ROLE;
