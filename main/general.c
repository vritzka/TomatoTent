...
lv_obj_t * ui_ElevationSpinbox;
lv_obj_t * ui_TemperatureOffsetSpinbox;
...
static void lv_spinbox_increment_event_cb(lv_event_t * e)
{
    ...
    my_tent.elevation = lv_spinbox_get_value(ui_ElevationSpinbox);
    my_tent.temperature_offset = lv_spinbox_get_value(ui_TemperatureOffsetSpinbox);
}
...
void spinboxes_init() {
	...
	ui_ElevationSpinbox = lv_spinbox_create(ui_Panel7);
	lv_obj_set_width( ui_ElevationSpinbox, 70);
	lv_obj_set_height( ui_ElevationSpinbox, 42);
	lv_obj_set_x( ui_ElevationSpinbox, 0 );
	lv_obj_set_y( ui_ElevationSpinbox, 17 );
	lv_obj_set_align( ui_ElevationSpinbox, LV_ALIGN_CENTER );
	lv_spinbox_set_digit_format( ui_ElevationSpinbox, 4, 0);
	lv_spinbox_set_range( ui_ElevationSpinbox, 0,8000 );
	lv_spinbox_set_step( ui_ElevationSpinbox, 1);
    ...
    lv_obj_add_event_cb(btn, lv_spinbox_decrement_event_cb, LV_EVENT_ALL, ui_ElevationSpinbox);
  
    ui_TemperatureOffsetSpinbox = lv_spinbox_create(ui_Panel9);
	lv_obj_set_width( ui_TemperatureOffsetSpinbox, 70);
	lv_obj_set_height( ui_TemperatureOffsetSpinbox, 42);
	lv_obj_set_x( ui_TemperatureOffsetSpinbox, 0 );
	lv_obj_set_y( ui_TemperatureOffsetSpinbox, 17 );
	lv_obj_set_align( ui_TemperatureOffsetSpinbox, LV_ALIGN_CENTER );
	lv_spinbox_set_digit_format( ui_TemperatureOffsetSpinbox, 2, 0);
	lv_spinbox_set_range( ui_TemperatureOffsetSpinbox, 0,20 );
	lv_spinbox_set_step( ui_TemperatureOffsetSpinbox, 1);

    btn = lv_btn_create(ui_Panel9);
    lv_obj_set_size(btn, h, h);
    lv_obj_align_to(btn, ui_TemperatureOffsetSpinbox, LV_ALIGN_OUT_RIGHT_MID, 5, 0);
    lv_obj_set_style_bg_img_src(btn, LV_SYMBOL_PLUS, 0);
    lv_obj_add_event_cb(btn, lv_spinbox_increment_event_cb, LV_EVENT_ALL, ui_TemperatureOffsetSpinbox);

    btn = lv_btn_create(ui_Panel9);
    lv_obj_set_size(btn, h, h);
    lv_obj_align_to(btn, ui_TemperatureOffsetSpinbox, LV_ALIGN_OUT_LEFT_MID, -5, 0);
    lv_obj_set_style_bg_img_src(btn, LV_SYMBOL_MINUS, 0);
    lv_obj_add_event_cb(btn, lv_spinbox_decrement_event_cb, LV_EVENT_ALL, ui_TemperatureOffsetSpinbox);
}
